    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen', models.URLField(max_length=225)),
                ...
                ('autor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='testblog.autor')),
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='testblog.categoria')),
            ],
            options={
                'verbose_name': 'Post',
